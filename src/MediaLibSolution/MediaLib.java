...
public class MediaLib
{
    public static void main(String[] args)
    {
        ...
        MediaFile.writeString(song1.getTitle() + ": " + song1.getPrice() + delim + song1.getRating());
        ...
        MediaFile.writeString(song2.getTitle() + ": " + song2.getTitle() + delim + song2.getRating());
        ...
        MediaFile.writeString(song9.getTitle() + ": " + song9.getPrice() + delim + song9.getRating());

        Song song10 =  new Song("Hey Jude", .99, 9);
        numSongs = numSongs + 1;
        totalCost = totalCost + song10.getPrice();
        totalRating = totalRating + song10.getRating();
        MediaFile.writeString(song10.getTitle() + ": " + song10.getPrice() + delim + song10.getRating());
